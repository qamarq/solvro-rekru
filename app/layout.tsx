                    ...
                    <ReactQueryProvider>
                        ...
                        <footer className='mt-10 border-t p-5'>
                            <div className='container mx-auto flex flex-col items-center justify-center'>
                                <h1 className='font-cal text-lg'>Made with ❤️ by <Link href="https://kamilmarczak.pl">Kamil Marczak</Link> for Solvro</h1>
                                <h3 className='text-muted-foreground text-sm'>© 2024 Kamil Marczak. All rights reserved.</h3>
                            </div>
                        </footer>
                    </ReactQueryProvider>
                </ThemeProvider>
